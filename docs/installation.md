...
- Generated Pi and OMP extensions and the generated OpenCode plugin resolve the Hitch API URL at runtime unless `--url` pins one, promote adapter metadata into Hitch envelope fields when available, and fail open if Hitch is unavailable.
